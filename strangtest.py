...
for i, nx in enumerate(nxs):
    ...
    FTCS  = test.Strang('FTCS','w')
    UpWind  = test.Strang('UpWind','w')
    LaxWendroff = test.Strang('LaxWendroff','w')
    BeamWarming  = test.Strang('BeamWarming','w')
